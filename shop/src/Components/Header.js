...
const Header = () => {
  return (
    <div className="flex justify-between p-4 items-center bg-stone-700 ">
      <div className="logo ml-8">
        <h1 className="text-2xl font-bold text-white pr-2 pl-2 hover hover:text-orange-300 transition-all duration-50 ease-in-out cursor-pointer">
          BeQuick
        </h1>
      </div>
