  ...
  <div className="container px-5 py-24 mx-auto" style={{ cursor: "auto" }}>
    <div className="lg:w-4/5 mx-auto flex flex-wrap">
      <img
        ...
        src={prodcutInfo?.image}
        style={{ cursor: "auto" ,width:"30%" ,height:"100%" }}
      />
      <div
      ...
      >
        ...
        <div className="flex mb-4">
          <span className="flex items-center">
            ...
            {prodcutInfo?.rating?.rate}
           
           
          
            <span className="text-gray-600 ml-3">{prodcutInfo?.rating?.count} Reviews</span>
          </span>
